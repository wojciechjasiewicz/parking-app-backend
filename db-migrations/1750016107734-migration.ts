...
export class Migration1750016107734 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "reservation" ("id" SERIAL NOT NULL, "parking_place_id" integer NOT NULL, "user_id" integer NOT NULL, "date" TIMESTAMP NOT NULL, CONSTRAINT "PK_48b1f9922368359ab88e8bfa525" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "parking_map" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "group_name" character varying NOT NULL, "file_type" character varying NOT NULL, "data" bytea NOT NULL, CONSTRAINT "PK_b4b09975297986db7df1b0c9791" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "parking_place" DROP CONSTRAINT "FK_f1b09cbc5e985c9cb15403e11dd"`,
    )
